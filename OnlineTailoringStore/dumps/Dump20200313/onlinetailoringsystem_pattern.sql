...
CREATE TABLE `pattern` (
  ...
  PRIMARY KEY (`idpat`),
  KEY `dressId` (`dressId`),
  CONSTRAINT `pattern_ibfk_1` FOREIGN KEY (`dressId`) REFERENCES `dress_type` (`id`)
...
INSERT INTO `pattern` VALUES (1,'punjabi',NULL,1000.00,1),(2,'gujrathi',NULL,900.00,1);
...
-- Dump completed on 2020-03-13  1:56:18
